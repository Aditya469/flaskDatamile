-- Create the database (adjust the name as needed) | Datamile flask application uses database with name 'datamile' 
CREATE DATABASE IF NOT EXISTS datamile;
USE datamile;
...
-- Create update_week_column procedure
DELIMITER //
...
-- Create the generate_forecasts procedure and required tables, I used the procedure to improve accuracy and reduce python dependencies for calculations.
DELIMITER //
...
-- add any required procedures above this comment.